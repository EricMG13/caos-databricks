...
Bundle folder `vendor/deploy-v/skills/cp-1b-earnings-delta/`, read through the verified `Bundle` seam and never edited. The pinned route, not this folder, decides when the node runs (`icm/CONTEXT.md`).

## Inputs

| Source | File | Section | Why |
|---|---|---|---|
| bundle | vendor/deploy-v/skills/cp-1b-earnings-delta/SKILL.md | whole | the module's authority, delivered first |
| bundle | vendor/deploy-v/skills/cp-1b-earnings-delta/references/CP-1B_SCHEMA_REFERENCE.md | whole | delivered authority file |
| bundle | vendor/deploy-v/skills/cp-1b-earnings-delta/references/CP-1B_SYSTEM_REFERENCE.md | whole | delivered authority file |
| bundle | vendor/deploy-v/skills/cp-1b-earnings-delta/references/REF_CP-1B_STEPS.md | whole | delivered authority file |
