...
Bundle folder `vendor/deploy-v/skills/cp-1c-peer-benchmark/`, read through the verified `Bundle` seam and never edited. The pinned route, not this folder, decides when the node runs (`icm/CONTEXT.md`).
