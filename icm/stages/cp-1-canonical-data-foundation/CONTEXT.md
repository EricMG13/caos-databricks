...
Bundle folder `vendor/deploy-v/skills/cp-1-canonical-data-foundation/`, read through the verified `Bundle` seam and never edited. The pinned route, not this folder, decides when the node runs (`icm/CONTEXT.md`).

## Inputs

| Source | File | Section | Why |
|---|---|---|---|
| bundle | vendor/deploy-v/skills/cp-1-canonical-data-foundation/SKILL.md | whole | the module's authority, delivered first |
| bundle | vendor/deploy-v/skills/cp-1-canonical-data-foundation/references/CP-1_RUNBOOK.md | whole | delivered authority file |
| bundle | vendor/deploy-v/skills/cp-1-canonical-data-foundation/references/CP-1_SCHEMA_REFERENCE.md | whole | delivered authority file |
| bundle | vendor/deploy-v/skills/cp-1-canonical-data-foundation/references/CP-1_SYSTEM_REFERENCE.md | whole | delivered authority file |
| bundle | vendor/deploy-v/skills/cp-1-canonical-data-foundation/references/REF_CP-1_STEPS.md | whole | delivered authority file |
